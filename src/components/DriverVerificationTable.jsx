...
const [pageSize] = useState(10); // ek page me kitne drivers
const [totalPages, setTotalPages] = useState(1);

// derived paginated drivers
...
// update total pages whenever drivers change
useEffect(() => {
  setTotalPages(Math.max(1, Math.ceil(drivers.length / pageSize)));
